...
A API da Wikipédia retorna um objeto JSON contendo um resumo de um artigo. Vamos criar uma classe em Dart para representar esse resumo. Crie o diretório wikipedia/lib/src/model.

mkdir -p wikipedia/lib/src/model
Crie o arquivo wikipedia/lib/src/model/summary.dart.

Adicione o seguinte código a wikipedia/lib/src/model/summary.dart 
